export default function ActivityLogs() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center', padding: 40 }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 800, color: '#f1f5f9', marginBottom: 10 }}>Activity Logs</h1>
      <p style={{ fontSize: 15, color: '#64748b', maxWidth: 420, lineHeight: 1.6, marginBottom: 28 }}>Track every action across the platform. Full audit trail for security and compliance.</p>
