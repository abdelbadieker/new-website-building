export default function Page() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center', padding: 40 }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 800, color: '#f1f5f9', marginBottom: 10 }}>Fulfillment Engine</h1>
      <p style={{ fontSize: 15, color: '#64748b', maxWidth: 420, lineHeight: 1.6, marginBottom: 28 }}>Configure shipping providers, manage warehouse operations, and automate order fulfillment.</p>
