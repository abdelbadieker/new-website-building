...
> Alternatively, run migration `supabase/migrations/20260423000001_raise_storage_limits.sql` — it creates/updates all buckets (`products`, `creative-briefs`, `uploads`) with the 100 MB limit idempotently.
